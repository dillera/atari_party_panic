...
z3_hack_infocom()
{
    ...
    interlz3 ~./Templates/Interpreters/info3k.bin ${STORY}.z3 ${STORY}_apple2.dsk
...
{
    #copy resources
    cp ~./Templates/Interpreters/apple2_boot.dsk .
    cp ~./Templates/Interpreters/apple2_template.dsk .
